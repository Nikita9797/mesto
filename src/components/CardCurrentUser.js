...
export class CardCurrentUser extends Card {
    constructor(data, templateSelector, handleOnCardClickFunc, handleLikeClickOnFunc, handleLikeClickOffFunc, handleOnTrashButtonClickFunc, userId) {
        super(data, templateSelector, handleOnCardClickFunc, handleLikeClickOnFunc, handleLikeClickOffFunc, userId);
